/**
 * Modal Sandbox Slack Bot Worker
 *
...
import type { CallbackContext, Env, RepoConfig, ThreadSession, UserPreferences } from "./types";
  ...
  const view = {
    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          type: "mrkdwn",
          text: "Configure your Modal Sandbox preferences below.",
        },
      },
      { type: "divider" },
      {
