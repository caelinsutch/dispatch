...
/**
 * Branch naming convention for Dispatch sessions.
 */
export const BRANCH_PREFIX = "dispatch";
 ...
 * @returns Branch name in format: dispatch/{session-id}
 */
 ...
 * @returns Session ID or null if not a Dispatch branch
 */
...
/**
 * Check if a branch name is a Dispatch branch.
 */
...
export function generateCommitMessage(
  ...
  return `${action}: ${description}\n\nCo-authored-by: Dispatch <dispatch@noreply.github.com>\nSession-ID: ${sessionId}`;
}
